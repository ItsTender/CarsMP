<%@ Page Title="" Language="C#" MasterPageFile="~/CarsMasterPage.Master" AutoEventWireup="true" CodeBehind="Cars.aspx.cs" Inherits="CarsMP.HTMLPages.Cars" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">


     <meta charset="utf-8" />
 <title> My Top 8 Favourite Cars </title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h1 data-text="Cars" style="font-family:serif"> Cars </h1>
    <ul>

        <li><h2 style="text-align:left"><a href="#a6AMGONE" style="color: deepskyblue; font-family:'Footlight MT'"> Mercedes AMG One </a></h2></li>
        <li><h2 style="text-align:left"><a href="#a1Carrera" style="color: deepskyblue; font-family:'Footlight MT'"> Porsche Carrera GT </a></h2></li>
        <li><h2 style="text-align:left"><a href="#a2SF90" style="color: deepskyblue; font-family: 'Footlight MT'"> Ferrari Sf90 Stradale </a></h2></li>
        <li><h2 style="text-align:left"><a href="#a7C8ZO6" style="color: deepskyblue; font-family:'Footlight MT'"> Chevrolet Corvette ZO6 </a></h2></li>
        <li><h2 style="text-align:left"><a href="#a3M2" style="color: deepskyblue; font-family: 'Footlight MT'"> BMW M2 </a></h2></li>
        <li><h2 style="text-align:left"><a href="#a4RS6" style="color: deepskyblue; font-family: 'Footlight MT'"> Audi RS6 Avant </a></h2></li>
        <li><h2 style="text-align:left"><a href="#a8GRYaris" style="color: deepskyblue; font-family:'Footlight MT'"> Toyota GR Yaris </a></h2></li>
        <li><h2 style="text-align:left"><a href="#a5Megane" style="color: deepskyblue; font-family: 'Footlight MT'"> Renault RS Trophy </a></h2></li>
    ...
    <hr>
        ...
        <div style="float:left; margin:10px;" id="a6AMGONE">
        <img src="../Images/AMGOne.jpg" title="Mercedes AMG ONE" alt="AMGOne" height="150">
    </div>
    <p>
    ...
    <a href="AMGOne.aspx" style="color: deepskyblue; text-underline-offset; font-family:Calibri"> Read More.... </a>
</h4>
    </p>

    <h6 style="text-align:center">
        <img src="../Images/AMGOne1.jpg" title="Mercedes AMG ONE" alt="AMGOne" height="100">
        <img src="../Images/AMGOneRear.jpg" title="Mercedes AMG ONE" alt="AMGOne" height="100">
        <img src="../Images/AMGOneInterior.jpg" title="Mercedes AMG ONE" alt="AMGOne" height="100">
    </h6>
    ...
    <div style="float:left; margin:10px;" id="a1Carrera">
        <img src="../Images/Carrera.jpg" title="Porsche Carrera GT" alt="CarreraGT" height="150">
    </div>
    <p>
        <h2> Porsche Carrera GT </h2> <h4>
    ...
    Sports Car International named the Carrera GT number one on its list of Top Sports Cars of the 2000s, and number eight on its Top Sports Cars of All Time list.
    For its advanced technology and development of its chassis, Popular Science magazine awarded it the "Best of What's New" award in 2003.
    The development of the Carrera GT can be traced back to the 911 GT1 and LMP1-98 racing cars. Due in part to the FIA and ACO rule changes in 1998, both designs had ended.
    Porsche at the time had planned a new Le Mans prototype for the 1999 season.
    ...
    Originally a production run of 1,500 cars was planned.
    <a href="CarreraGT.aspx" style="color: deepskyblue; text-underline-offset; font-family:Calibri"> Read More.... </a>
</h4>
    </p>

    <h6 style="text-align:center">
        <img src="../Images/Carrera2.jpg" title="Porsche Carrera GT" alt="CarreraGT" height="100">
        <img src="../Images/CarreraRear.jpg" title="Porsche Carrera GT" alt="CarreraGT" height="100">
        <img src="../Images/CarreraInterior.jpg" title="Porsche Carrera GT" alt="CarreraGT" height="100">
    </h6>
    <h3 style="text-align:center"> <a href="#top"> 
        <img src="../Images/Top_Arrow.png" title="Go To Top" alt="TopArrow" height="55">  
    </a> </h3> <hr>
    ...
    <div style="float:left; margin:10px;" id="a2SF90">
        <img src="../Images/SF90.jpg" title="Ferrari SF90 Stradale" alt="SF90" height="150">
    </div>
    <p>
        <h2> Ferrari SF90 Stradale </h2> <h4>
    The Ferrari SF90 Stradale (Type F173) is a mid-engine PHEV (plug-in hybrid electric vehicle) sports car produced by the Italian automobile manufacturer Ferrari. The car shares its name with the SF90 Formula One car with SF90 standing for the 90th anniversary of the Scuderia Ferrari racing team and "Stradale" meaning "made for the road".  he SF90 Stradale is equipped with three electric motors, adding a combined output of 220 PS (162 kW; 217 bhp) to a twin-turbocharged V8 engine rated at a power output of 780 PS (574 kW; 769 hp) at 7,500 rpm. The car is rated at a total output of 1,000 PS (735 kW; 986 hp) at 8,000 rpm and a maximum torque of 800 N⋅m (590 lb⋅ft) at 6,000 rpm.
    ...
    Ferrari states that the SF90 Stradale is capable of accelerating from a standstill to 100 km/h (62 mph) in 2.5 seconds, 0–200 km/h (124 mph) in 6.7 seconds and can attain a top speed of 340 km/h (211 mph). It is the fastest Ferrari road car on their Fiorano Circuit as of 2020, seven tenths of a second faster than the LaFerrari. The Manufacturer also claims that the SF90 Stradale can generate 390 kg (860 lb) of downforce at 250 km/h (155 mph) due to new findings in aero and thermal dynamics.
    ...
    <a href="SF90Stradale.aspx" style="color: deepskyblue; text-underline-offset; font-family:Calibri"> Read More.... </a>
</h4>
    </p>

    <h6 style="text-align:center">
        <img src="../Images/SF902.jpg" align="middle" title="Ferrari SF90 Stradale" alt="SF90" height="100">
        <img src="../Images/SF90Rear.jpg" align="middle" title="Ferrari SF90 Stradale" alt="SF90" height="100">
        <img src="../Images/SF90Interior.jpg" align="middle" title="Ferrari SF90 Stradale" alt="SF90" height="100">
    </h6>
    <h3 style="text-align:center"> <a href="#top"> 
        <img src="../Images/Top_Arrow.png" title="Go To Top" alt="TopArrow" height="55">  
    </a> </h3> <hr>
                ...
                <div style="float:left; margin:10px;" id="a7C8ZO6">
        <img src="../Images/ZO6corvette.jpg" title="Chevrolet Corvette ZO6" alt="C8ZO6" height="180">
    </div>

        <p>
        <h2> Chevrolet Corvette ZO6 </h2> <h4>
            ...
            The Z06 uses a new naturally aspirated 5.5 L V8 producing 670 hp (500 kW; 679 PS) at 8,400 rpm, 460 lb⋅ft (624 N⋅m) of torque at 6,300 rpm and has a redline of 8,600 rpm. This engine, dubbed the LT6, features a double overhead camshaft (DOHC) and a flat-plane crank, and surpasses the Mercedes-Benz SLS AMG Black Series' M159 engine to become the most powerful naturally aspirated production V8. A modified version of this engine has powered the Chevrolet Corvette C8.R since 2019, and many features in the racing engine carry over to the road engine. Other features of this new engine include a cast aluminum block, dual coil valve springs supporting titanium intake & sodium filled exhaust valves, forged aluminum pistons, forged titanium connecting rods, active split intake manifold with twin 87mm throttle bodies, four-into-two-into-one stainless steel exhaust headers, and a factory six-stage 10-quart dry sump oiling system with individual crank bay scavenging. A feature the LT6 shares with other Chevrolet small blocks is the bore spacing of 4.4 inches. The Z06 uses the same 8-speed dual-clutch transmission used by Stingray models, albeit with a shorter 5.56:1 final drive ratio for improved acceleration. Chevrolet claims this allows the Z06 to accelerate from 0–60 mph (0–97 km/h) in 2.6 seconds. The Z06 features the same basic suspension setup as the Stingray, however the electronic limited-slip differential and magnetic ride adaptive suspension system are now standard for all Z06 trims. The Z07 Performance Package includes the FE7 track-oriented suspension setup.


    <a href="CorvetteZO6.aspx" style="color: deepskyblue; text-underline-offset; font-family:Calibri"> Read More.... </a>
</h4>
    </p>

    <h6 style="text-align:center">
        <img src="../Images/ZO6corvette1.jpg" title="Chevrolet Corvette ZO6" alt="C8ZO6" height="115">
        <img src="../Images/ZO6corvetteRear.jpg" title="Chevrolet Corvette ZO6" alt="C8ZO6" height="115">
        <img src="../Images/ZO6corvetteInterior.jpg" title="Chevrolet Corvette ZO6" alt="C8ZO6" height="115">
    ...
    <hr>
        ...
        <div style="float:left; margin:10px;" id="a3M2">
        <img src="../Images/M2.jpg" title="BMW M2" alt="M2" height="120">
    </div>
    ...
    <h3 style="text-align:center"> <a href="#top"> 
        <img src="../Images/Top_Arrow.png" title="Go To Top" alt="TopArrow" height="55">  
                        ...
                        <div style="float:left; margin:10px;" id="a8GRYaris">
        <img src="../Images/Yaris.jpg" title="Toyota GR Yaris" alt="GRYaris" height="140">
    </div>
    ...
    <a href="RenaultMegane.aspx" style="color: deepskyblue; text-underline-offset; font-family:Calibri"> Read More.... </a>
</h4>
    </p>

    <h6 style="text-align:center">
        <img src="../Images/meganerear.jpg" title="Megane RS Trophy" alt="MeganeRS" height="100">
        <img src="../Images/megane2.jpg" title="Megane RS Trophy" alt="MeganeRS" height="100">
        <img src="../Images/meganeinterior.jpg" title="Megane RS Trophy" alt="MeganeRS" height="100">
    </h6>
    <h3 style="text-align:center"> <a href="#top"> 
        <img src="../Images/Top_Arrow.png" title="Go To Top" alt="TopArrow" height="55">  
    </a> </h3>
