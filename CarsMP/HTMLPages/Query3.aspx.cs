    ...
    public partial class Query3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // SQL Select Code!!
                sqlSelect += " where email LIKE '%gmail%' and city IN(N'Nazareth', N'Jerusalem', N'Tel Aviv')";
                ...
                msg = " <h3 style=\"color:deepskyblue; font-size:x-large; font-family:Calibri\"> there are " + length + " registered user/s that use 'Gmail' and live in Nazareth, Jerusalem or Tel Aviv</h3>";
