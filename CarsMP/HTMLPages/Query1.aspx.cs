...
{
    public partial class Query_1 : System.Web.UI.Page
    {
        public string st = "";
        public string msg = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                msg = " <h3 style=\"color:deepskyblue; font-size:x-large; font-family:Calibri\"> there are " + length + " registered user/s that have the letter 'a' in their First Names </h3>";
