    ...
    public partial class Query2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // SQL Select Code!!
                sqlSelect += " where lName LIKE N'%s%'";
                ...
                msg = " <h3 style=\"color:deepskyblue; font-size:x-large; font-family:Calibri\"> there are " + length + " registered user/s that have the letter 's' in their Last Names </h3>";
