        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < length; i++)
                {
                    ...
                    st += "<tr>";
                    deleteActionUser = table.Rows[i]["uName"].ToString();
                    st += "<td style = 'text-align: center; border: 1px solid black;'>";
                    st += "<a href = 'DeleteAction.aspx?uName=" + deleteActionUser + "' style=\"color: deepskyblue\" >[delete]</a>";
                    st += "</td>";
